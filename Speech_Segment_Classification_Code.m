...
% Classify frames into voiced, unvoiced, or silence based on the threshold
...
% Plot the audio signal with highlighted regions
t = (0:length(x)-1) / fs;
...
% Function to calculate Zero Crossing Rate for each frame
